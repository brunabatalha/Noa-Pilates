...
const T = {
  en: {
    ...
    classBookings: "Class Bookings — Admin Override",
    open: "🟢 Open",
    lockedAdmin: "🔴 Locked",
      ...
      <div style={S.page}>
        ...
        <div style={{...S.card,padding:"14px 16px",marginBottom:24,borderLeft:`4px solid ${C.wine}`}}>
          ...
          <div style={{display:"flex",gap:10,flexWrap:"wrap",alignItems:"center"}}>
            ...
            <button onClick={()=>{if(!selClientForPkg){fire("Select a client","warn");return;}setShowPkgModal(true);setPkgStep(1);}} style={{...S.wineBtn,padding:"9px 18px",fontSize:12}}>{ t.addPackage }</button>
          </div>
                ...
                <div key={i} style={{...S.card,marginBottom:7,borderLeft:`4px solid ${att.length>0?C.wine:C.border}`,padding:"11px 14px"}}>
                  <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:12}}>
                    ...
                    <div style={{textAlign:"right",flexShrink:0}}>
                      ...
                      <div style={{fontSize:10,color:C.textLight,marginBottom:6}}>{lang==="pt"?"marcados":"booked"}</div>
      ...
      {showPkgModal&&(
        <div style={S.overlay} onClick={()=>setShowPkgModal(false)}>
          <div style={S.modal} onClick={e=>e.stopPropagation()}>
            ...
            <p style={{margin:"0 0 16px",fontSize:12,color:C.textLight}}>{ t.forClient } <b style={{color:C.wine}}>{selClientForPkg}</b></p>
            {pkgStep===1&&(
